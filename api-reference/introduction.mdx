...
### <Icon icon="microchip" /> Arquitetura e Motor
...
## <Icon icon="route" /> Fluxo de Trabalho
...
## <Icon icon="shield-check" /> Autenticação
...
## <Icon icon="file-code" /> Formato de Resposta
