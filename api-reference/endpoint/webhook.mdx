...
### <Icon icon="brackets-curly" /> Placeholders Disponíveis
...
### <Icon icon="code" /> Exemplo de Payload Recebido
...
## <Icon icon="shield-check" /> Segurança
