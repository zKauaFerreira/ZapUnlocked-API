...
## <Icon icon="pie-chart" iconType="sharp-regular" color="#9d4fe6" size={22} /> Divisão da Memória RAM
...
## <Icon icon="gauge-high" iconType="sharp-regular" color="#9d4fe6" size={22} /> Dicas de Performance
